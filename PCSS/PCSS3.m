...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function Setting(obj)
            ...
            load(fullfile(fileparts(CallStack(1).file),'Dataset_PCSS.mat'),'PCSS3');
...
%             obj.M = 2;
            ...
            %
            obj.capacity = PCSS3.capacity(1:obj.pc_num);
            obj.consume  = PCSS3.consumption(1:obj.pc_num);
            obj.required = PCSS3.required(1:obj.pc_num);
            obj.times = ceil(obj.required ./ obj.capacity);
            obj.costs = PCSS3.costs;
            for i = 1:obj.pc_num
