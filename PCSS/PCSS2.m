...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function Setting(obj)
            ...
            load(fullfile(fileparts(CallStack(1).file),'Dataset_PCSS.mat'),'PCSS2');
...
%             obj.M = 2;
            ...
            %
            obj.capacity = PCSS2.capacity(1:obj.pc_num);
            obj.consume  = PCSS2.consumption(1:obj.pc_num);
            obj.required = PCSS2.required(1:obj.pc_num);
            obj.times = ceil(obj.required ./ obj.capacity);
            obj.costs = PCSS2.costs;
            for i = 1:obj.pc_num
